...
namespace PortalWeb.Controllers
{
    public class StatesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            {
                var applicationDbContext2 = _context.States.Where(s => s.Name.Contains(searchString) || s.Country.Name.Contains(searchString) || s.StateId.ToString() == searchString ).Include(s => s.Country);
